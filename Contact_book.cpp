...
class ContactBook
{
	...
	public:
		...
		void reopenCB()
		{
            ...
            {
            	cout<<"  Contact book managnment system is Empty so Cannot open...Sorry kindly enter contacts"<<endl;
			}
		}
		void Structure()
    	{
	    	cout<<"||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||"<<endl<<endl<<endl;                    
	    	cout<<"                                       ******************************  PRESS 1. Add Contact TO Contact Managnment System************************"<<endl<<endl;
	    	cout<<"                                       ******************************  PRESS 2. Edit the Contact Managnment System******************************"<<endl<<endl;
	    	cout<<"                                       ******************************  PRESS 3. Delete Contact FROM Managnment System***************************"<<endl<<endl;
	    	cout<<"                                       ******************************  PRESS 4. Search Contact FROM contact Managnment System*******************"<<endl<<endl;
	    	cout<<"                                       ******************************  PRESS 5. Display All Contacts********************************************"<<endl<<endl;
	    	cout<<"                                       ******************************  PRESS 6. Delete All Contacts*********************************************"<<endl<<endl;
	    	cout<<"***********"<<endl;
...
system("color F1");
	...
	cout<<endl;
	cout<<endl;
	cout<<"                                       ||||||||||||||||||||||||||||||Please Enter Your Name As Admin: ||||||||||||||||||||||||||||||";
	cin>>n;
	
    cout<<"                                                   ||||||||||||||||||********************************:||||||||||||||||||||||||||||||"<<endl;
	cout<<"                                       <<<<<<<<<<<<<<<<<<<<<<<<<<<<ADMIN NAME SETS AS    :"<<n<<cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl<<endl<<endl;
	cout<<"                                                                   WELCOME TO CONTACTBOOK MANAGNMENT SYSYTEM      "<<endl;
	cout<<"****************************************************************************************************************************************************************************"<<endl;
	cb.Structure();
	return 0;
}
